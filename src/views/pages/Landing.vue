...
const usersData = ref(['alfred', 'bastion', 'charot', 'franki', 'hodly', 'hyper', 'shodan']);
    ...
    <div :class="(menu?.classList.contains('hidden') && menu?.classList.contains('absolute') ? 'h-auto ' : 'overflow-hidden h-screen  md:h-auto ') + 'landing-wrapper'">
        ...
        <div class="flex items-center justify-between relative lg:static py-12 mx-0 px-6 lg:py-12">
            ...
            <a
                ...
                v-styleclass="{ selector: '@next', enterFromClass: 'hidden', enterActiveClass: 'animate-fadein', leaveToClass: 'hidden', leaveActiveClass: 'px-fadeout', hideOnOutsideClick: 'true' }"
            >
            ...
            <ul
                ...
                class="list-none flex-grow-1 justify-end hidden md:flex absolute md:relative h-screen md:h-auto bg-surface-0 dark:bg-surface-900 md:bg-surface-50 dark:md:bg-surface-950 m-0 z-50 w-full sm:w-6/12 md:w-full py-12 md:py-0"
            >
                <a
                    class="cursor-pointer block md:hidden dark:text-surface-100 text-primary absolute"
                    style="top: 3rem; right: 2rem"
                    v-styleclass="{ selector: '@parent', enterFromClass: 'hidden', enterActiveClass: 'px-scalein', leaveToClass: 'hidden', leaveActiveClass: 'px-fadeout' }"
                >
        ...
        <div ref="home" id="home" class="landing-banner px-6 md:px-20 py-20 lg:flex flex-wrap">
            <div class="banner-left w-full lg:w-8/12">
                ...
                <Button label="Learn More" icon="pi pi-arrow-right" size="large" class="mb-12"></Button>
                ...
                <div class="logo-section relative w-full md:w-8/12 mt-12 users-container">
                    ...
                    <div class="marquee-wrapper overflow-hidden flex">
                        <div v-for="i of [1, 2, 3]" :key="i" class="marquee">
                            <template v-for="user of usersData" :key="user">
                                <div class="w-full">
                                    <img :src="`/demo/images/landing/logocloud/${user}-500.svg`" :alt="user" />
                                </div>
                            </template>
                        </div>
                    </div>
        ...
        <div ref="features" id="features" class="landing-section px-6 md:px-20 py-20 mb-20">
            <div class="section-top lg:flex w-full gap-12 items-center mb-12">
                <span class="block font-normal text-6xl sm:text-7xl xl:text-8xl text-surface-900 dark:text-surface-0 lg:w-8/12">Wide range of features and the stylish use of <b class="text-primary font-medium">PrimeVue</b> components</span>
                <div class="lg:w-4/12 lg:mt-0 mt-8">
                    <h3 class="font-normal text-surface-900 dark:text-surface-0 m-0 mb-12 w-full" style="letter-spacing: 0.6px">
            ...
            <div class="feature-cards grid grid-cols-12 gap-4 mt-20 pt-6">
                <div class="col-span-12 sm:col-span-6 lg:col-span-4">
                    <div class="card p-0 h-full">
                        <svg animateEnter="animate-fadein" viewBox="0 0 443 257" class="w-full rounded-3xl mb-6" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g mask="url(#mask0_436_2188)">
                                <g opacity="0.05">
                                    <rect x="-30.082" y="-14.1369" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="-30.082" y="-14.1369" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="141.918" y="-14.1369" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="141.918" y="-14.1369" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="313.918" y="-14.1369" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="313.918" y="-14.1369" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="-116.082" y="15.8631" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="-116.082" y="15.8631" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="55.918" y="15.8631" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="55.918" y="15.8631" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.15">
                                    <rect x="227.918" y="15.8631" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="227.918" y="15.8631" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="399.918" y="15.8631" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="399.918" y="15.8631" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.15">
                                    <rect x="-30.082" y="45.8631" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="-30.082" y="45.8631" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="141.918" y="45.8631" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="141.918" y="45.8631" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="313.918" y="45.8631" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="313.918" y="45.8631" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="-116.082" y="75.8631" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="-116.082" y="75.8631" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="55.918" y="75.8631" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="55.918" y="75.8631" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="227.918" y="75.8631" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="227.918" y="75.8631" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.15">
                                    <rect x="399.918" y="75.8631" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="399.918" y="75.8631" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="-30.082" y="105.863" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="-30.082" y="105.863" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.15">
                                    <rect x="141.918" y="105.863" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="141.918" y="105.863" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="313.918" y="105.863" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="313.918" y="105.863" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.15">
                                    <rect x="-116.082" y="135.863" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="-116.082" y="135.863" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="55.918" y="135.863" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="55.918" y="135.863" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="227.918" y="135.863" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="227.918" y="135.863" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.15">
                                    <rect x="399.918" y="135.863" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="399.918" y="135.863" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="-30.082" y="165.863" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="-30.082" y="165.863" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="141.918" y="165.863" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="141.918" y="165.863" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="313.918" y="165.863" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="313.918" y="165.863" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="-116.082" y="195.863" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="-116.082" y="195.863" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="55.918" y="195.863" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="55.918" y="195.863" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="227.918" y="195.863" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="227.918" y="195.863" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="399.918" y="195.863" width="155" height="15" rx="6.5" fill="var(--p-primary-500)" />
                                    <rect x="399.918" y="195.863" width="155" height="15" rx="6.5" stroke="var(--p-primary-300)" />
                                </g>
                                <rect x="84.5507" y="97.8894" width="273.565" height="45" rx="13.5" fill="var(--p-primary-300)" style="opacity: 0.9" />
                                <path
                                ...
                                />
                                <rect x="84.5507" y="97.8894" width="273.565" height="45" rx="13.5" stroke="var(--p-primary-300)" />
                            </g>
                            <defs>
                        ...
                        <h4 class="font-medium m-0 mb-4 px-8">Easy to use</h4>
                        <span class="p-0 m-0 text-xl block leading-normal px-8 pb-8" style="letter-spacing: 0.4px">A user-friendly interface that is intuitive and simple to navigate, enabling users to quickly find the information they need.</span>
                    </div>
                </div>
                <div class="col-span-12 sm:col-span-6 lg:col-span-4">
                    <div class="card p-0 h-full">
                        <svg animateEnter="animate-fadein" class="w-full rounded-3xl mb-6" viewBox="0 0 444 257" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g mask="url(#mask0_436_2247)">
                                ...
                                <rect x="192.866" y="89.0972" width="58" height="58" rx="25.5" fill="var(--p-primary-300)" style="opacity: 0.9" />
                                ...
                                <rect x="192.866" y="89.0972" width="58" height="58" rx="25.5" stroke="var(--p-primary-300)" />
                            </g>
                            <defs>
                        ...
                        <h4 class="font-medium m-0 mb-4 px-8">Page Speed</h4>
                        <span class="p-0 m-0 text-xl block leading-normal px-8 pb-8" style="letter-spacing: 0.4px">A website that loads quickly, providing users with a seamless browsing experience and improving SEO rankings.</span>
                    </div>
                </div>
                <div class="col-span-12 sm:col-span-6 lg:col-span-4">
                    <div class="card p-0 h-full">
                        <svg animateEnter="animate-fadein" class="w-full rounded-3xl mb-6" viewBox="0 0 443 257" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g mask="url(#mask0_436_2322)">
                                ...
                                <rect x="36.9992" y="99.3926" width="369" height="26" rx="5.5" fill="var(--p-primary-300)" opacity="0.8" />
                                <rect x="46.4992" y="108.893" width="350" height="7" rx="3" fill="var(--p-primary-700)" />
                                <rect x="36.9992" y="99.3926" width="369" height="26" rx="5.5" stroke="var(--p-primary-300)" />

                                <rect x="37.0806" y="138.682" width="305.791" height="6.97623" rx="2.90676" fill="var(--p-primary-500)" opacity="0.5" />
                                <rect x="37.0806" y="138.682" width="305.791" height="6.97623" rx="2.90676" stroke="var(--p-primary-300)" stroke-width="1.1627" />

                                <rect x="37.0806" y="156.123" width="266.259" height="6.97623" rx="2.90676" fill="var(--p-primary-500)" opacity="0.5" />
                                <rect x="37.0806" y="156.123" width="266.259" height="6.97623" rx="2.90676" stroke="var(--p-primary-300)" stroke-width="1.1627" />
                        ...
                        <h4 class="font-medium m-0 mb-4 px-8">SEO</h4>
                        <span class="p-0 m-0 text-xl block leading-normal px-8 pb-8" style="letter-spacing: 0.4px">
                    ...
                    <div class="card p-0 h-full">
                        <svg animateEnter="animate-fadein" class="w-full rounded-3xl mb-6" viewBox="0 0 443 257" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g mask="url(#mask0_436_2345)">
                                ...
                                <rect x="28.9248" y="26.5128" width="382.892" height="225.401" rx="7.94682" stroke="var(--p-primary-500)" stroke-width="1.44488" />
                                <rect x="139.458" y="49.6307" width="161.826" height="179.165" rx="7.94682" fill="var(--surface-card)" />
                                <circle cx="220.371" cy="212.749" r="6.57779" stroke="var(--p-primary-600)" />
                                <rect x="139.458" y="49.6307" width="161.826" height="179.165" rx="7.94682" stroke="var(--p-primary-500)" stroke-width="1.44488" />
                                <rect x="190.751" y="83.5854" width="59.24" height="111.256" rx="7.94682" fill="var(--p-primary-500)" opacity="0.5" />
                                <circle cx="220.371" cy="177.957" r="6.57779" fill="var(--p-primary-300)" />
                                <rect x="190.751" y="83.5854" width="59.24" height="111.256" rx="7.94682" stroke="var(--p-primary-500)" stroke-width="1.44488" />
                            </g>
                            <defs>
                        ...
                        <h4 class="font-medium m-0 mb-4 px-8">Responsive</h4>
                        <span class="p-0 m-0 text-xl block leading-normal px-8 pb-8" style="letter-spacing: 0.4px">A design that adapts to different screen sizes and devices, ensuring that content is accessible and easy to read on all devices.</span>
                    </div>
                </div>
                <div class="col-span-12 sm:col-span-6 lg:col-span-4">
                    <div class="card p-0 h-full">
                        <svg animateEnter="animate-fadein" class="w-full rounded-3xl mb-6" viewBox="0 0 444 257" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g mask="url(#mask0_436_2360)">
                                ...
                                />
                                <rect y="0.561843" width="65.178" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 336.923 66.7666)" fill="var(--p-primary-500)" />
                                ...
                                <rect y="0.561843" width="65.178" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 336.923 66.7666)" stroke="var(--p-primary-300)" stroke-width="1.12376" />

                                <rect y="0.561843" width="65.178" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 222.081 127.852)" fill="var(--p-primary-500)" />
                                ...
                                <rect y="0.561843" width="65.178" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 222.081 127.852)" stroke="var(--p-primary-300)" stroke-width="1.12376" />

                                <rect y="0.561843" width="65.178" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 222.109 10.8927)" fill="var(--p-primary-500)" />
                                ...
                                <rect y="0.561843" width="65.178" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 222.109 10.8927)" stroke="var(--p-primary-300)" stroke-width="1.12376" />

                                <rect y="0.561843" width="65.178" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 107.267 71.9784)" fill="var(--p-primary-500)" />
                                ...
                                <rect y="0.561843" width="65.178" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 107.267 71.9784)" stroke="var(--p-primary-300)" stroke-width="1.12376" />
                            </g>
                            <defs>
                        ...
                        <h4 class="font-medium m-0 mb-4 px-8">Browser Support</h4>
                        <span class="p-0 m-0 text-xl block leading-normal px-8 pb-8" style="letter-spacing: 0.4px"
                    ...
                    <div class="card p-0 h-full">
                        <svg animateEnter="animate-fadein" class="w-full rounded-3xl mb-6" viewBox="0 0 443 257" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g mask="url(#mask0_436_2387)">
                                ...
                                <rect x="139.84" y="57.5968" width="163.653" height="141.806" rx="70.9032" fill="var(--p-primary-500)" opacity="0.89" />
                                <path
                                    ...
                                    fill="var(--p-primary-700)"
                                />
                                <rect x="139.84" y="57.5968" width="163.653" height="141.806" rx="70.9032" stroke="var(--p-primary-300)" stroke-width="0.915632" />
                            </g>
                            <defs>
                                ...
                                <radialGradient id="paint2_radial_436_2387" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(164.569 71.3611) rotate(180) scale(158.904 151.525)">
                                    <stop offset="0.776042" stop-color="var(--p-primary-700)" stop-opacity="0" />
                                    <stop offset="1" stop-color="var(--p-primary-700)" />
                                </radialGradient>
                        ...
                        <h4 class="font-medium m-0 mb-4 px-8">Accessibility</h4>
                        <span class="p-0 m-0 text-xl block leading-normal px-8 pb-8" style="letter-spacing: 0.4px"
        ...
        <div ref="customizations" id="customizations" class="landing-section px-6 md:px-20 py-20 mt-20">
            ...
            <div class="video relative" style="max-width: 62rem; margin: 0 auto">
                ...
                <Button icon="pi pi-play !text-8xl !ml-4" @click="showModalDialog()" class="!absolute !top-1/2 !right-1/2 !text-3xl" rounded style="margin-right: -5rem; margin-top: -5rem; height: 10rem; width: 10rem"></Button>
            </div>
        ...
        <div ref="apps" id="apps" class="landing-section px-6 md:px-20 py-20 mt-20">
        ...
        <!-- background: linear-gradient(to left bottom, var(--p-primary-50), var(--p-surface-0)) -->
        <div ref="pricing" id="pricing" class="landing-section px-6 md:px-20 py-20 mt-20">
