                ...
                <div>
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex flex-wrap flex-col gap-4">
                            <div class="flex">
                                <div class="flex items-center gap-2 w-1/2">
                                    <RadioButton name="menuTheme" value="light" v-model="layoutConfig.menuTheme" inputId="menu-light" :disabled="layoutConfig.menuMode === 'horizontal' && isDarkTheme"></RadioButton>
                                    <label for="menu-light">Light</label>
                                </div>
                                <div class="flex items-center gap-2 w-1/2">
                                    <RadioButton name="menuTheme" value="dark" v-model="layoutConfig.menuTheme" inputId="menu-dark" :disabled="layoutConfig.menuMode === 'horizontal' && !isDarkTheme"></RadioButton>
                                    <label for="menu-dark">Dark</label>
                                </div>
                            </div>
                        </div>
                    </div>
